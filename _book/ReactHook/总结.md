...
而它们的实现又是从reactBeginWork。js
先 prepareToReadContext
接着 prepareToUseHooks
中间执行Component
最后执行finishHooks
...
redux作者 Dan 加入到React 推行了Hook

```js
if(reucer === basicStateReducer){
...
我们没个fiber 对应没个组件，hook 代表更细粒度的fiber,
